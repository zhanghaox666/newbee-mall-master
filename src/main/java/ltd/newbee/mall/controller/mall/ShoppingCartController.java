...
public class ShoppingCartController {
    ...
    public void addToHDFS( int id, HttpSession httpSession){
        ...
        NewBeeMailShoppingCartItemLogs newBeeMailShoppingCartItemLogs = new NewBeeMailShoppingCartItemLogs();
        newBeeMailShoppingCartItemLogs.setUserId(user.getUserId());
        NewBeeMallGoods newBeeMallGoods = newBeeMallGoodsService.getNewBeeMallGoodsById(Long.valueOf(id));


        newBeeMailShoppingCartItemLogs.setGoodsName(newBeeMallGoods.getGoodsName());
        newBeeMailShoppingCartItemLogs.setGoodsIntro(newBeeMallGoods.getGoodsIntro());
        newBeeMailShoppingCartItemLogs.setGoodsId(newBeeMallGoods.getGoodsId());
        newBeeMailShoppingCartItemLogs.setUpdateTime(newBeeMallGoods.getUpdateTime());
        newBeeMailShoppingCartItemLogs.setSellingPrice(newBeeMallGoods.getSellingPrice());
        newBeeMailShoppingCartItemLogs.setGoodsCategoryId(newBeeMallGoods.getGoodsCategoryId());
